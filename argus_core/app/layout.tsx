...
import { PrivacyRuntimeEnforcer } from '@/components/shared/PrivacyRuntimeEnforcer';
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${urbanist.variable} ${monoFont.variable} scroll-smooth`}
