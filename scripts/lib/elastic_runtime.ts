  ...
  return {
    argonaut_runs: {
      ...
      mappings: {
        ...
        properties: {
          runId: { type: 'keyword', doc_values: true, index: true, norms: false },
          ...
          executionMode: { type: 'keyword', doc_values: true, index: true, norms: false },
          pipelineVersion: { type: 'keyword', doc_values: true, index: true, norms: false },
          status: { type: 'keyword', doc_values: true, index: true, norms: false },
          startedAt: { type: 'date' },
          endedAt: { type: 'date' },
          stageSummary: { type: 'object', dynamic: true },
          counts: { type: 'object', dynamic: true },
          errorSummary: { type: 'object', dynamic: false },
          createdAt: { type: 'date' },
        },
      },
    },
    argonaut_tasklogs: {
      ...
      mappings: {
        ...
        properties: {
          runId: { type: 'keyword', doc_values: true, index: true, norms: false },
          seq: { type: 'integer' },
          stage: { type: 'keyword', doc_values: true, index: true, norms: false },
          taskType: { type: 'keyword', doc_values: true, index: true, norms: false },
          taskKey: { type: 'keyword', doc_values: true, index: true, norms: false },
          taskId: { type: 'keyword', doc_values: true, index: true, norms: false },
          status: { type: 'keyword', doc_values: true, index: true, norms: false },
          startedAt: { type: 'date' },
          endedAt: { type: 'date' },
          durationMs: { type: 'integer' },
          message: { type: 'keyword', doc_values: true, index: true, norms: false },
          refs: { type: 'object', dynamic: false },
          error: {
            type: 'object',
            dynamic: 'strict',
            properties: {
              code: { type: 'keyword', doc_values: true, index: true, norms: false },
              message: { type: 'keyword', doc_values: true, index: true, norms: false },
            },
          },
          createdAt: { type: 'date' },
